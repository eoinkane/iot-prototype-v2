...
const cdkSpaDeploy = require('cdk-spa-deploy');
  ...
  constructor(scope, id, props) {
    ...
    const fn = new lambda.Function(this, 'ProtoV2AppLambda', {
      ...
      code: lambda.Code.fromAsset(
        path.join(__dirname, '../build/lambda-app-build/lambda-app-build.zip')
      ),
      environment: {
    ...
    const swagger = openapiJs.getOpenApi(
    ...
    const website = new cdkSpaDeploy.SPADeploy(
      this,
      'spaDeploy'
    ).createBasicSite({
      indexDoc: 'index.html',
      websiteFolder: 'build/ui-build/',
      errorDoc: 'index.html',
    });
  }
}
